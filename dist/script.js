...
/***/ "./src/js/modules/bubblesCanvas.js":
/*!*****************************************!*\
  !*** ./src/js/modules/bubblesCanvas.js ***!
  \*****************************************/
/***/ (function() {
...
/***/ "./src/js/modules/modalConfiguration.js":
/*!**********************************************!*\
  !*** ./src/js/modules/modalConfiguration.js ***!
  \**********************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var _store_storage__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../store/storage */ "./src/js/store/storage.js");
/* harmony import */ var _plugins_swiper__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../plugins/swiper */ "./src/js/plugins/swiper.js");
  ...
  createModal() {
    this.btns.forEach(item => {
      item.addEventListener('click', () => {
        const attrValue = item.getAttribute('data-modal'); // Запускаем получение данных с сервера (storage.init();) и записываем их в переменную

        _store_storage__WEBPACK_IMPORTED_MODULE_1__["default"].init();
        const response = _store_storage__WEBPACK_IMPORTED_MODULE_1__["default"].projects;
        response.then(data => {
          // data.data.projects
          data.data.projects.forEach(({
            ...
            if (attrValue == dataAttribute) {
              ...
              this.modal.classList.add('modal'); // Создание слайдов swiper'a
              ...
              if (screen.availWidth > 700) {
                document.querySelector('.modal__content-wrapper').style.width = getComputedStyle(document.querySelector('.modal__content')).width.slice(0, 3) * pictures.length + 'px';
              } // инициализируем слайдер


              _plugins_swiper__WEBPACK_IMPORTED_MODULE_2__["default"].initSlider(); // инициализируем закрытие модального окна
              ...
              document.body.style.marginRight = _modules_scroll__WEBPACK_IMPORTED_MODULE_0__["default"].calcScrollBarOffset();
              this.modal.style.paddingRight = _modules_scroll__WEBPACK_IMPORTED_MODULE_0__["default"].calcScrollBarOffset();
              this.modal.style.paddingLeft = _modules_scroll__WEBPACK_IMPORTED_MODULE_0__["default"].calcScrollBarOffset();
            }
          });
        });
      });
...
/* harmony default export */ __webpack_exports__["default"] = (modalConfig);
...
/* harmony default export */ __webpack_exports__["default"] = (scrollActions);
...
/***/ "./src/js/modules/workWithNavbar.js":
/*!******************************************!*\
  !*** ./src/js/modules/workWithNavbar.js ***!
  \******************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/* harmony default export */ __webpack_exports__["default"] = (workWithNavbar);
...
/* harmony export */   "returnSuccessToast": function() { return /* binding */ returnSuccessToast; },
/* harmony export */   "returnFailureToast": function() { return /* binding */ returnFailureToast; },
/* harmony export */   "returnFormToast": function() { return /* binding */ returnFormToast; }
/* harmony export */ });
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  M.ScrollSpy.init(scrollSpy); // sidenav
...
function returnSuccessToast() {
  return M.toast({
    html: 'Ваше письмо успешно отправлено!'
  });
}
function returnFailureToast() {
  return M.toast({
    html: 'Произошла непредвиденная ошибка...'
  });
}
function returnFormToast() {
  return M.toast({
...
class SwiperSlider {
  ...
  initSlider() {
    const swiper = new swiper_bundle__WEBPACK_IMPORTED_MODULE_0__["default"]('.modal__content-block', {
      slidesPerView: 1,
      speed: 400,
      grabCursor: true
    });
...
/* harmony import */ var _modules_validateInputs__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../modules/validateInputs */ "./src/js/modules/validateInputs.js");
...
class Api {
  ...
  async getRequest() {
    return await this.axios(_config_apiConfig__WEBPACK_IMPORTED_MODULE_0__["default"].urlGet);
  }
  ...
  async postMessageToEmail(form) {
    fetch('smart.php', {
      ...
      if (res.ok) {
        (0,_plugins_materialize__WEBPACK_IMPORTED_MODULE_1__.returnSuccessToast)();
      } else {
        (0,_plugins_materialize__WEBPACK_IMPORTED_MODULE_1__.returnFailureToast)();
      }
    }).catch(() => (0,_plugins_materialize__WEBPACK_IMPORTED_MODULE_1__.returnFailureToast)()).finally(() => {
      form.reset();
  ...
  async onSubmit() {
    this.forms.forEach(form => {
      form.addEventListener('submit', e => {
        e.preventDefault();
        _modules_validateInputs__WEBPACK_IMPORTED_MODULE_2__["default"].init();

        if (_modules_validateInputs__WEBPACK_IMPORTED_MODULE_2__["default"].errors == 0) {
          this.submitBtn.innerHTML = _config_apiConfig__WEBPACK_IMPORTED_MODULE_0__["default"].getSpinnerHTML();
          this.postMessageToEmail(form);
        } else {
          (0,_plugins_materialize__WEBPACK_IMPORTED_MODULE_1__.returnFormToast)();
        }
      });
    });
  }
...
/* harmony import */ var _config_apiConfig__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../config/apiConfig */ "./src/js/config/apiConfig.js");
...
class Storage {
  ...
  init() {
    this.projects = _services_apiServices__WEBPACK_IMPORTED_MODULE_0__["default"].getRequest();
  }
...
/***/ "./src/js/views/projectsCardHover.js":
/*!*******************************************!*\
  !*** ./src/js/views/projectsCardHover.js ***!
  \*******************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/* harmony default export */ __webpack_exports__["default"] = (projectsCardHover);
...
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _config_apiConfig__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./config/apiConfig */ "./src/js/config/apiConfig.js");
/* harmony import */ var _plugins_index__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./plugins/index */ "./src/js/plugins/index.js");
/* harmony import */ var _modules_bubblesCanvas__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/bubblesCanvas */ "./src/js/modules/bubblesCanvas.js");
/* harmony import */ var _modules_bubblesCanvas__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(_modules_bubblesCanvas__WEBPACK_IMPORTED_MODULE_2__);
/* harmony import */ var _views_projectsCardHover__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./views/projectsCardHover */ "./src/js/views/projectsCardHover.js");
/* harmony import */ var _views_filterCards__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./views/filterCards */ "./src/js/views/filterCards.js");
/* harmony import */ var _modules_modalConfiguration__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./modules/modalConfiguration */ "./src/js/modules/modalConfiguration.js");
/* harmony import */ var _services_apiServices__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./services/apiServices */ "./src/js/services/apiServices.js");
/* harmony import */ var _modules_workWithNavbar__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./modules/workWithNavbar */ "./src/js/modules/workWithNavbar.js");
...
/* harmony import */ var _modules_validateInputs__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./modules/validateInputs */ "./src/js/modules/validateInputs.js");
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  async function appInit() {
    _config_apiConfig__WEBPACK_IMPORTED_MODULE_0__["default"].testWebP(function (support) {
      if (support == true) {
    ...
    _views_projectsCardHover__WEBPACK_IMPORTED_MODULE_3__["default"].init();
    _views_filterCards__WEBPACK_IMPORTED_MODULE_4__["default"].init();
    _modules_modalConfiguration__WEBPACK_IMPORTED_MODULE_5__["default"].init();
    _services_apiServices__WEBPACK_IMPORTED_MODULE_6__["default"].onSubmit();
    _modules_workWithNavbar__WEBPACK_IMPORTED_MODULE_7__["default"].init();
    _modules_scroll__WEBPACK_IMPORTED_MODULE_8__["default"].initScrollAnimation();
    _modules_scroll__WEBPACK_IMPORTED_MODULE_8__["default"].correctMovementToSections();
    _modules_validateInputs__WEBPACK_IMPORTED_MODULE_9__["default"].removeStylesFromInputs();
  }
});
}();
/******/ })()
